    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-10 offset-1">
                <br>
                <br>
                <h2 align="center" class="Style4"><span class="Style8">Liste des Clients </span></h2>
                <br>
                <br>
                ...
                <table width="100%" border="1"  cellspacing="0" >
                    ...
                    @foreach($clients as $client)
                        <tr >
                            ...
                            <td><a href="">{{$client->numeroCNI}}</a></td>
                            <td><a href="">{{$client->nom}}</a></td>
                            <td><a href="">{{$client->grade}}</a></td>
                            <td><a href="">{{$client->fonction}}</a></td>
                            <td><a href="">{{$client->tel}}</a></td>
                        </tr>
                    @endforeach
                </table>
            </div>
