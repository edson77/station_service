    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-10 offset-1">
                <br>
                <br>
                <h2 align="center" class="Style4"><span class="Style8">Liste des consommations </span></h2>
                <br>
                <br>
                ...
                <table width="100%" border="1"  cellspacing="0" >
                    ...
                    @foreach($consomations as $consomation)
                        <tr >
                            ...
                            <td>{{$consomation->quantite_carburant}}</td>
                            <td>{{$consomation->montant_consomation}}</td>
                            <td>{{$consomation->immatriculation}}</td>
                            <td>{{$consomation->numeroCNI}}</td>
                        </tr>
                    @endforeach
                </table>
            </div>
